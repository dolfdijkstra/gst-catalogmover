 ...
 * the chunks
 * 
 * It is silent in the sense that it calls handleException, but calls process on
 * other chunks and elements if an exceptions was throw from the processor.
 * 
 ...
 */
public abstract class AbstractChunkProcessor<T, E extends Exception> extends SimpleChunkProcessor<T, E> {
    ...
    protected abstract IterableProcessor<T, E> getIterableProcessor(Processor<T, E> processor);
